  ...
  return (
    <section ref={blockRef} className="relative px-8">
      <div className="border-b border-[#5C5C5C] text-center pb-34 pt-47">
        <div className="bg-linear-to-r absolute right-60 top-120 z-10 rounded-full w-25 h-25 from-[#F8EEA4] to-[#C7A008] p-[2px]">
          ...
          >
            {block.map((line, lineIndex) => (
              <RevealLine
                ...
                className="font-anton font-medium opacity-80 leading-[68px] tracking-[0.02rem] w-max text-6xl"
              >
                {line.text}
              </RevealLine>
            ))}
